...
| Framework-neutral; depends on `embabel-agent-ai`
| Experimental
...
| Depends on both real provider adapters
| Experimental
...
| Adds the platform and decision autoconfiguration; no provider is enabled by default
| Experimental
|===
