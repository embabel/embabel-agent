...
Embabel provides built-in `MatryoshkaTool` implementations for introspecting the current agent process and its blackboard.
...
// Create with default formatting
val blackboardTools: MatryoshkaTool = BlackboardTools().create()
