...
===== Comparison with Search-Based Tool Discovery

Other agent frameworks address large tool collections with *search-based* approaches that require additional infrastructure:
...
|===
|Aspect |Search-Based Approaches |MatryoshkaTool

|*Infrastructure*
|Requires vector stores, embeddings, or search indices
|No additional infrastructure required

|*Latency*
|Search adds latency per discovery step
...
|*Cost*
|Embedding generation and vector search incur compute costs
