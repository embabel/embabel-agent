...
/**
 * Compiled source for the TypeSafe reference examples. Calls remain synchronous and return native
 * SDK responses so application code can retain the evidence it needs.
 */
public class TypeSafeUsageExamples {
    ...
    public TypeSafeClient client(Supplier<String> apiKey) {
        return TypeSafeClients.create(TypeSafeClientOptions.defaults(), apiKey);
    }
     ...
     *
     * @param client native TypeSafe client
