...
// ─── Domain model ────────────────────────────────────────────────────────────
// Identical to WaitForMvcIntegrationTest and HitlJdbcPersistenceMvcIntegrationTest.
...
@Profile("hitl-cache")
private class HitlJCachePersistenceTestApplication
 ...
 *
 * The [HitlJCachePersistenceTestConfig] below is your starting
 ...
 *
 * @see HitlJdbcPersistenceMvcIntegrationTest for the JDBC
 * equivalent using a hand-rolled SQL snapshot store.
 */
@SpringBootTest(classes = [HitlJCachePersistenceTestApplication::class])
@ActiveProfiles("test", "hitl-cache")
@TestPropertySource(properties = ["embabel.agent.platform.persistence.enabled=true"])
@AutoConfigureMockMvc
class HitlJCachePersistenceMvcIntegrationTest {
    ...
    @TestConfiguration
    @Profile("hitl-cache")
    class HitlJCachePersistenceTestConfig {
