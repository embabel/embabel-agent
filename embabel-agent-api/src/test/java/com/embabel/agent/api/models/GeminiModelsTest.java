...
class GeminiModelsTest {
    ...
    @Test
    void shouldProvideGemini3_1Models() {
    ...
    @Test
    void shouldProvideGemini2_5Models() {
    ...
    @Test
    void shouldProvideGemini2_0Models() {
    ...
    @Test
    void shouldProvideCorrectProvider() {
    ...
    @Test
    void shouldProvideEmbeddingModels() {
