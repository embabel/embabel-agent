...
class QosInjectionIntegrationTest private constructor(
    ...
    fun `action qos correctly injected`() {
        ...
        assertTrue(
            (methodManager.actionQosProvider as DefaultActionQosProvider).perActionQosProperties.agents
                .contains("agent")
        )
        assertEquals(
            (methodManager.actionQosProvider as DefaultActionQosProvider).perActionQosProperties.default
                .maxAttempts, 6
        )
    }
}
