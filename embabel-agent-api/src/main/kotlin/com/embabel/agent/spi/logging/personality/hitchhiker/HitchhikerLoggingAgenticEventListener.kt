...
The standard repository for all knowledge and wisdom in the universe
 ...
 |_| /_/    \_\_| \_|_____\_____|
    ...
    override fun getLlmRequestEventMessage(e: LlmRequestEvent<*>): String =
        "[${e.processId}] 🧠 DEEP THOUGHT: calculating LLM ${e.llm.name} to transform ${e.interaction.id.value} from ${e.outputClass.simpleName} -> ${e.interaction.llm} using ${e.interaction.tools.joinToString { it.definition.name }}"
