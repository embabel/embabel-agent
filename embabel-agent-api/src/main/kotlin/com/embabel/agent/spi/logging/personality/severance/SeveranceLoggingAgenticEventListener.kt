...
class SeveranceLoggingAgenticEventListener : LoggingAgenticEventListener(
    ...
    override fun getLlmRequestEventMessage(e: LlmRequestEvent<*>): String =
        "[${e.processId}] (${e.interaction.id.value}) \uD83D\uDDA5\uFE0F MACRODATA REFINEMENT using LLM ${e.llm.name}, creating ${e.outputClass.simpleName}: ${e.interaction.llm} with tools ${e.interaction.tools.joinToString { it.definition.name }}"
